...
try{
    $pdo = new PDO('mysql:dbname=gs_englishdb;charset=utf8;host=localhost','root','');
    }catch(PDOException $e){
        exit('DBError'.$e->getMessage());
    }
// $stmt = $pdo->prepare("SELECT * FROM gs_english_table");
// $status = $stmt->execute();
...
<header>
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header"><a class="navbar-brand" href="index.php">単語登録</a></div>
    </div>
  </nav>
</header>
